...
| Open milestone | **None active.** The **accounting-dashboard roadmap is FULLY complete (11 surfaces)** — the 2026-06-24 suite (#319–#328) + 2026-06-25's A/R aging (#330), Owner scorecard (#332), and refund-side fee reconciliation (#335). **No roadmap items remain.** Remaining is operator activation only (Marketing send + Resend webhook + FTS flag) + 2 outstanding cutover invoices. **CI:** the Admin visual regression check is green again (#331 recaptured the drifted baselines). |
