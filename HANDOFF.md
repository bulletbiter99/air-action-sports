...
| `main` HEAD | re-pull for exact (all merged through #425). Migrations **0001–0080 ALL applied on remote** — the 2026-07-31 growth-plan session added **none**. |
| Tests | **3631 / 307 passing** · reproduce CI exactly with `TZ=UTC npx vitest run` (the runner is UTC; a naive-ISO fixture is ambient-TZ-dependent) |
...
| Open PRs | 0 (all merged through #411; only branch is `main`) |
