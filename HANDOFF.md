...
| Open milestone | **M8 work menu CLEARED** — all items done + deployed (item-1 RTL long tail #299–#304; admin design-consistency sweep #306 + #308–#315 + the #317 close-off). No in-flight milestone. Remaining is operator activation only (Marketing send + Resend webhook + FTS flag) + 2 outstanding cutover invoices. |
...
main=51559fb (re-pull for exact), tests 2945/251 passing, migrations
