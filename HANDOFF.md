...
| `main` HEAD | re-pull for exact (all merged through #416). Migrations **0001–0080 ALL applied on remote** (0080 applied 2026-07-28; SUA seed verified, agreement uploads work). |
| Tests | **3611 / 304 passing** · reproduce CI exactly with `TZ=UTC npx vitest run` (the runner is UTC; a naive-ISO fixture is ambient-TZ-dependent) |
...
3. Sanity checks:
   ...
   - `TZ=UTC npx vitest run` → **3611 passing across 304 files** (as of the 2026-07-28 timezone-follow-ups close).
