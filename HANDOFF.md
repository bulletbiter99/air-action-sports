...
accounting roadmap, multi-day events, Operation Last Light (now LIVE),
and the attendee-verified reviews feature (all 7 batches, migration 0077)
are all done + deployed; production stable at main=4fbbf4a (re-pull for
exact), tests 3142/275 passing, migrations 0001-0077 applied, live Stripe.
Read these in order:
