...
| `main` HEAD | **`0e64078`** + docs sync · re-pull for exact (all merged through #392). Migrations **0001–0079 ALL APPLIED**. |
| Tests | **3359 / 287 passing** · reproduce CI exactly with `TZ=UTC npx vitest run` (the runner is UTC; a naive-ISO fixture is ambient-TZ-dependent) |
...
3. Sanity checks:
   ...
   - `npm test` → **3003 passing across 259 files** (vitest unit suite as of the 2026-06-24 accounting-suite close).
...
audit's Sprints 1-2 are closed (Sprints 3-4 remain). The entire
date_iso timezone family was fixed + deployed 2026-07-27 (PRs #391 +
#392). Production is stable at main=0e64078 (re-pull for exact), tests
3359/287 passing, migrations 0001-0079 ALL applied, 0 open PRs.

NOTHING IS BLOCKING. Pick from the work menu at the top of
docs/next-session.md — admin-audit Sprints 3-4, the growth plan
(not started), or the two agreed follow-ups from the timezone series.
