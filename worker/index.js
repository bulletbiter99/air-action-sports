...
import adminEventArchive from './routes/admin/eventArchive.js';
import adminVendorPackageTemplates from './routes/admin/vendorPackageTemplates.js';
...
import adminIncidents from './routes/admin/incidents.js';
import { adminExpenses, adminBudgets } from './routes/admin/finances.js';
import adminCashFlow from './routes/admin/cashFlow.js';
...
import adminFieldRentalRecurrences from './routes/admin/fieldRentalRecurrences.js';
...
app.route('/api/reviews', publicReviews);
...
app.route('/api/admin/event-archive', adminEventArchive);
app.route('/api/admin/vendor-package-templates', adminVendorPackageTemplates);
...
app.route('/api/admin/incidents', adminIncidents);
...
app.route('/api/admin/field-rental-recurrences', adminFieldRentalRecurrences);
app.route('/api/admin/saved-views', adminSavedViews);
app.route('/api/admin/expenses', adminExpenses);
app.route('/api/admin/budgets', adminBudgets);
app.route('/api/admin/cash-flow', adminCashFlow);
