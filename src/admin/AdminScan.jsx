...
const input = { padding: '10px 12px', background: 'var(--dark)', border: '1px solid var(--color-border-strong)', color: 'var(--cream)', fontSize: 13, fontFamily: 'inherit' };
...
const historyBox = { marginTop: 18, background: 'var(--mid)', border: '1px solid var(--color-border)', padding: '1rem' };
...
const modal = { background: 'var(--mid)', border: '1px solid var(--color-border-strong)', padding: '1.25rem', width: '100%', maxWidth: 560, borderRadius: 4 };
