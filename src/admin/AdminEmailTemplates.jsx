...
const modal = { background: 'var(--mid)', border: '1px solid var(--color-border-strong)', padding: '1.5rem', width: '100%', maxWidth: 820, borderRadius: 4, maxHeight: '92vh', overflowY: 'auto' };
