...
const section = { background: 'var(--mid)', border: '1px solid var(--color-border)', padding: '1.5rem', marginBottom: 24 };
...
const modalCard = { background: 'var(--mid)', border: '1px solid var(--color-border-strong)', padding: '2rem', maxWidth: 560, width: '100%' };
...
const input = { width: '100%', padding: '10px 14px', background: 'var(--dark)', border: '1px solid var(--color-border-strong)', color: 'var(--cream)', fontSize: 13, outline: 'none', boxSizing: 'border-box', fontFamily: 'inherit' };
