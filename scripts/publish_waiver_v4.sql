-- Phase A correction: publish Waiver Document v4.
-- v3 included the "Minor Participant Notice" block (the Hawkins v. Peart /
-- Rutherford v. Talisker Canyons explainer about Utah minor-waiver law).
-- Per owner direction, that block is for internal reference only and should
-- not be customer-facing. v4 removes the notice block and its heading; the
-- rest of the document (incl. Age Participation Policy, which IS
-- customer-relevant) is preserved verbatim.
--
...
<p>Additional sites will be added to this Exhibit as AAS expands operations. The Agreement remains valid and applicable at all sites regardless of the date a site is added to this Schedule.</p>
    ...
    '291c333a29027aea7ec53c5efcc991b2f108a63f533863f758101b47d8f1cbc7',
    unixepoch() * 1000,
    NULL,
    NULL,
    unixepoch() * 1000
