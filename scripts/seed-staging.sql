...
INSERT OR IGNORE INTO bookings (id, event_id, full_name, email, phone, player_count, line_items_json, subtotal_cents, discount_cents, tax_cents, fee_cents, total_cents, status, payment_method, stripe_payment_intent, created_at, paid_at, refunded_at, cancelled_at) VALUES
    ...
    ('bk_seed_sarah_03', 'ev_seed_past_b', 'Sarah Chen', 'sar.ahchen@gmail.com', '5551110001', 1, '[{"type":"ticket","ticket_type_id":"tt_seed_past_b_std","name":"Standard","qty":1,"unit_price_cents":8500,"line_total_cents":8500}]', 8500, 0, 255, 277, 9032, 'paid', 'card', 'pi_seed_sarah_03', unixepoch('2026-04-01') * 1000, unixepoch('2026-04-01') * 1000, NULL, NULL),
