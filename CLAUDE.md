...
**Status (as of 2026-05-07, post-B8b):**
...
4. Read this section + the next pending batch's row in the table above (B9 is next — persona-tailored AdminDashboard with `new_admin_dashboard` flag; old AdminDashboard preserved as fallback)
